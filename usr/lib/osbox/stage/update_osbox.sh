...
source /usr/lib/osbox/func/getgitfiles
...
getgitfiles /usr/local/src/osbox https://github.com/jerryhopper/osbox.git
#update_repo /usr/local/src/osbox
chmod +x /usr/sbin/osbox

echo ". "
echo "Updating OSBox web."
getgitfiles /var/www/html/osbox https://github.com/jerryhopper/blackboxweb.git
